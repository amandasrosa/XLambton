        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (agent.getName().isEmpty() || agent.getPhotoPath().isEmpty()) {
                    Toast.makeText(NewAgentActivity.this, "Insert a valid name and photo", Toast.LENGTH_SHORT);
                } else {
                    try {
                        AgentDAO dao = new AgentDAO(NewAgentActivity.this);
                        dao.dbInsert(agent);
                        Toast.makeText(NewAgentActivity.this, "Agent saved", Toast.LENGTH_SHORT);
                        finish();
                    } catch (Exception e) {
                        Toast.makeText(NewAgentActivity.this, "Error while saving agent", Toast.LENGTH_SHORT);
                    }
                }
            }
        });
